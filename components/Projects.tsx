...
const projects = [
  ...
  { name: 'Portalog',     thumb: '/portalog.png',    domain: 'SaaS · Freight & Logistics',       desc: 'End-to-end logistics management platform for freight forwarder and PPJK companies in Indonesia — shipment tracking, document management, and customs clearance workflow.', url: 'https://portalog.vercel.app/',       stack: ['Next.js','React','Tailwind']},
